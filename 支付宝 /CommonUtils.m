...
void NAV_INIT(UIViewController *vc ,NSString *title, NSString *left ,SEL leftObj, NSString *right, SEL rightObj)
{
    ...
    CGContextSetFillColorWithColor(context, [[UIColor colorWithRed:0.933 green:0.203 blue:0.258 alpha:1]  CGColor]);
    ...
    [vc.navigationController.navigationBar setBackgroundImage:image forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
    ...
    if(left != nil){
        ...
        UIImageView *leftImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 24, 24)];
    ...
    if(right != nil){
        ...
        UIView *view = [[UIView alloc]initWithFrame:CGRectMake(220, 0, 60, 20)];
        UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 60, 20)];
        UILabel *titleTxt = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 60, 20)];
        titleTxt.text = right;
        [titleTxt setFont:[UIFont systemFontOfSize:19.0f]];
    ...
    if(title != nil){
        ...
        [titleView setFont:[UIFont systemFontOfSize:19.0f]];
        [titleView setTextColor:TextColor_Black];
...
void NAV_IMGINIT(UIViewController *vc ,NSString *title, NSString *left ,SEL leftObj, NSString *right, SEL rightObj)
{
    ...
    if(left != nil){
        UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(10, 8, 20, 30)];
        UIImageView *leftImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 7, 9, 16)];
        leftImgView.image = [UIImage imageNamed:left];
        [button addSubview:leftImgView];
        [button addTarget:vc.self action:leftObj forControlEvents:UIControlEventTouchUpInside];
        UIBarButtonItem *leftBarBtnItem = [[UIBarButtonItem alloc] initWithCustomView:button];
...
//定义导航视图---右侧有2个按钮
void NAV_IMGINIT2(UIViewController *vc ,NSString *title, NSString *left ,SEL leftObj, NSString *right, SEL rightObj,NSString *right2, SEL rightObj2)
{
    //根据颜色生成image
    CGRect rect = CGRectMake(0.0f, 0.0f, 1.0f, 1.0f);
    UIGraphicsBeginImageContext(rect.size);
    ...
    if(right != nil){
        UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(220, 10, 30, 44)];
        
        UIImage *image = [UIImage imageNamed:right];
        CGFloat size = image.size.width > image.size.height ? image.size.width : image.size.height;
        size = size>30 ? 30 : size;
        
        UIImageView *rightImgView = [[UIImageView alloc] initWithFrame:CGRectMake((30-size)/2, (44-size)/2, size, size)];
        rightImgView.contentMode = UIViewContentModeCenter;
        rightImgView.image = image;
        ...
        UIButton *button2 = [[UIButton alloc] initWithFrame:CGRectMake(220, 10, 30, 44)];
        
        UIImage *image2 = [UIImage imageNamed:right2];
        CGFloat size2 = image2.size.width > image2.size.height ? image2.size.width : image2.size.height;
        size2 = size2>30 ? 30 : size2;
        
        UIImageView *rightImgView2 = [[UIImageView alloc] initWithFrame:CGRectMake((30-size2)/2, (44-size2)/2, size2, size2)];
        rightImgView2.contentMode = UIViewContentModeCenter;
        rightImgView2.image = image2;
        
        [button2 addSubview:rightImgView2];
        [button2 addTarget:vc.self action:rightObj2 forControlEvents:UIControlEventTouchUpInside];
        
        [button2 setBackgroundColor:[UIColor clearColor]];
        UIBarButtonItem *rightBtnItem2 = [[UIBarButtonItem alloc] initWithCustomView:button2];
        [vc.navigationItem setRightBarButtonItems:[NSArray arrayWithObjects:rightBtnItem,rightBtnItem2, nil]];
...
//定义导航视图---首页用
void NAV_IMGTITLEINIT(UIViewController *vc ,CGFloat r,CGFloat g,CGFloat b,CGFloat tranlusent)
{
    //根据颜色生成image
    CGRect rect = CGRectMake(0.0f, 0.0f, 1.0f, 1.0f);
    UIGraphicsBeginImageContext(rect.size);
    ...
    CGContextSetFillColorWithColor(context, [[UIColor colorWithRed:r green:g blue:b alpha:tranlusent]  CGColor]);
    CGContextFillRect(context, rect);
