...
+(void)show:(UIViewController *)vc text:(NSString *)text image:(id)image{
    ...
    [UMSocialSnsService presentSnsIconSheetView:vc appKey:[CoreUMeng umengGetAppKey] shareText:text shareImage:image shareToSnsNames:@[UMShareToWechatSession,UMShareToWechatFavorite,UMShareToQQ,UMShareToQzone] delegate:vc];
