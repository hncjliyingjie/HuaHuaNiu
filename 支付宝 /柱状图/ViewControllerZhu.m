...
#import "ViewControllerZhu.h"
#import "ZFChart.h"

@interface ViewControllerZhu ()

@end

@implementation ViewControllerZhu
...
//    barChart.title = @"xx小学各年级人数占比";
    barChart.xLineValueArray = [NSMutableArray arrayWithObjects:@"200",@"300", nil];
