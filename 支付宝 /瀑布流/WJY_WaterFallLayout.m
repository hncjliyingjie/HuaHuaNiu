...
#import "CaptialCollectionReusableView.h"
...
//    
//    UICollectionView* collectionView=[[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenWidth-44)collectionViewLayout:flowLayout];
...
- (void)layoutForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGFloat newHeight = rect.origin.y + rect.size.height + self.verticaSpacing;
...
{
    [collectionView registerClass:[CaptialCollectionReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"HeaderView"];
    UILabel * lable=[[UILabel alloc]initWithFrame:CGRectMake(5, 0, ScreenWidth, 30)];
