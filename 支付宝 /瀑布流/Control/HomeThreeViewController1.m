...
#import "HomeThreeViewController1.h"
...
@interface HomeThreeViewController1 ()< UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate,SDCycleScrollViewDelegate,SYStickHeaderWaterFallDelegate>
{
    NSInteger showPage;
...
@implementation HomeThreeViewController1
...
-(void)initCollectionView
{
    ...
    self.collectView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 40, kDeviceWidth, kDeviceHeight ) collectionViewLayout:cvLayout];
