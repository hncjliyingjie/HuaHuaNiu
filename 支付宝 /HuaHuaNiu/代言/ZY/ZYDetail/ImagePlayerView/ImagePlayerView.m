...
- (void)reloadData
{
    ...
    //self.count = self.numberItems;
    self.pageControl.numberOfPages = self.count;
    self.pageControl.currentPage = 0;
    self.pageControl.currentPageIndicatorTintColor = [UIColor redColor];
    self.pageControl.pageIndicatorTintColor = [UIColor colorWithWhite:1.000 alpha:0.400];
    if(self.count==1)
    {
    ...
    //UIImage *sub2 = [UIImage imageNamed:@"icon_grayTimerIcon.png"];
