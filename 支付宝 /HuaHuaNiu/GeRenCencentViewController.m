...
@interface GeRenCencentViewController ()

@end

@implementation GeRenCencentViewController
...
- (IBAction)YInHangKAction:(id)sender {
    CardViewController *cvc =[[CardViewController alloc]init];
    [self.navigationController pushViewController: cvc animated:YES];
}

- (IBAction)ShouHuoDiZhiAction:(id)sender {
...
- (IBAction)GerenziLiaoAction:(id)sender {
