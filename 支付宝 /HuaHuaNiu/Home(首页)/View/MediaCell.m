...
-(void)layoutCell
{
    ...
    self.playtimeLabel=[[UILabel alloc]initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width-145, 255, 160, 15)];
    [self.playtimeLabel setFont:[UIFont systemFontOfSize:10]];
    [self.contentView addSubview:self.playtimeLabel];
    self.playtimeImage=[[UIImageView alloc]initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width-160, 255, 15, 15)];
